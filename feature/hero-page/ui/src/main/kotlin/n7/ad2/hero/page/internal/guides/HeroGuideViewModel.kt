...
class HeroGuideViewModel @AssistedInject constructor(private val getVOHeroGuideItemsUseCase: GetVOHeroGuideItemsUseCase) :
    ViewModel(),
    ...
    fun loadHeroWithGuides(heroName: String): LiveData<List<VOGuideItem>> = getVOHeroGuideItemsUseCase(heroName)
