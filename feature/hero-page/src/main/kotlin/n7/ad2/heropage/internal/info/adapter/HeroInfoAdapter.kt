...
import n7.ad2.heropage.internal.info.domain.vo.VOBodyLine
import n7.ad2.heropage.internal.info.domain.vo.VOBodySimple
import n7.ad2.heropage.internal.info.domain.vo.VOBodyTalent
import n7.ad2.heropage.internal.info.domain.vo.VOBodyWithImage
...
class HeroInfoAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (holder) {
            is HeroHeaderPlayableViewHolder -> if (item != null) holder.bind(item as VOHeroInfo.HeaderSound)
            ...
            else -> error("Could not find view to bind")
        }
    }
