...
internal class UpdateStateViewedForHeroUseCaseImpl(private val heroesRepository: HeroesRepository, private val dispatcher: DispatchersProvider) : UpdateStateViewedForHeroUseCase {
