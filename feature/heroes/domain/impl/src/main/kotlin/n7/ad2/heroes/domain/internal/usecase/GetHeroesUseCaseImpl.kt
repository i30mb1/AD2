...
internal class GetHeroesUseCaseImpl(private val heroesRepository: HeroesRepository) : GetHeroesUseCase {

    override fun invoke(): Flow<List<Hero>> = heroesRepository.getAllHeroes()
}
