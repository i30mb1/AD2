...
class CameraSettingsImpl(override val isFrontCamera: Boolean = true, override val isDebug: Boolean = true, override val aspectRatio: CameraAspectRatio = CameraAspectRatio.RATIO_16_9) : CameraSettings
