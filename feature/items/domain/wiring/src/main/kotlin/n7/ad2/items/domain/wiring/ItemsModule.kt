...
object ItemsModule {
    ...
    @dagger.Provides
    fun provideHeroesDomainComponent(res: Resources, dispatchers: DispatchersProvider, appInformation: AppInformation, application: Application, logger: Logger): ItemsDomainComponent =
        ItemsDomainComponent(
