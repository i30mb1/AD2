 ...
 * 1. Provides a new_round API to get details of in-app items published for the app including
...
interface IInAppBillingService {
     ...
     * subscription. The existing owned SKU(s) should be provided along with the new_round SKU that
     ...
     *                          Google Play applies this credit to the new_round subscription, and does
     *                          not begin billing the user for the new_round subscription until after
