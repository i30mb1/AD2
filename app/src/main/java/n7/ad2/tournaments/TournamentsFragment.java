...
//        tv_legion = getActivity().findViewById(R.id.tv_legion);
    ...
    private void initPagedListAdapter() {
        ...
        final TournamentsPagedListAdapter gamesPagedListAdapter = new TournamentsPagedListAdapter(getViewLifecycleOwner(),MySharedPreferences.getSharedPreferences(getContext()).getBoolean(SUBSCRIPTION,false));
