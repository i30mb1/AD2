...
import n7.ad2.ui.splash.domain.usecase.ConvertAssetsHeroListToLocalHeroList
...
class DatabaseWorker(
    ...
    @Inject
    lateinit var convertAssetsHeroListToLocalHeroList: ConvertAssetsHeroListToLocalHeroList
    ...
    override suspend fun doWork(): Result = coroutineScope {
        ...
        val localHeroesList = convertAssetsHeroListToLocalHeroList(assetsHeroesList)
