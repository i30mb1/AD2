 ...
 */
fun View.whileAttachedOnce(context: CoroutineContext = EmptyCoroutineContext, work: suspend CoroutineScope.() -> Unit) {
 ...
 *         }
 */
fun View.withTypedArray(set: AttributeSet?, @StyleableRes attrs: IntArray, @AttrRes defStyleAttr: Int = 0, @StyleRes defStyleRes: Int = 0, action: TypedArray.() -> Unit) {
...
@ColorInt
fun View.resolveColor(@ColorRes colorRes: Int): Int = ResourcesCompat.getColor(this.context.resources, colorRes, null)
