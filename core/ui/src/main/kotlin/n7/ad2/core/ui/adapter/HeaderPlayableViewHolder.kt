...
import n7.ad2.core.ui.databinding.ItemHeaderPlayableBinding

class HeaderPlayableViewHolder private constructor(private val binding: ItemHeaderPlayableBinding, private val onPlayIconClick: (soundUrl: String) -> Unit) : RecyclerView.ViewHolder(binding.root) {
    ...
    companion object {
        fun from(layoutInflater: LayoutInflater, parent: ViewGroup, onPlayIconClick: (soundUrl: String) -> Unit): HeaderPlayableViewHolder {
