...
Java_n7_ad2_nativesecret_NativeSecretExtractor_createNative(JNIEnv *env, jobject thiz) {
...
Java_n7_ad2_nativesecret_NativeSecretExtractor_nativeResizeBitmap(JNIEnv *env, jobject thiz, jlong native_handle, jobject input_bitmap,
                                                                  jobject output_bitmap) {
    RenderScriptToolkit* toolkit = reinterpret_cast<RenderScriptToolkit*>(native_handle);
    RestrictionParameter restrict {env, NULL};
    BitmapGuard input{env, input_bitmap};
    BitmapGuard output{env, output_bitmap};
